...
Route::middleware('auth')->group(function () {
    Route::middleware('itm')->group(function () {
        ...
        Route::get('/requests/itm-report', [PtppRequestController::class, 'showReport'])->name('ptpp-requests.report.show');
        Route::get('/requests/itm-report/export', [PtppRequestController::class, 'exportReport'])->name('ptpp-requests.report.export');
